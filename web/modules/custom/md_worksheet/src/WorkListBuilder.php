...
/**
 * Provides a list controller for the work entity type.
 */
class WorkListBuilder extends EntityListBuilder {
  ...
  /**
   * Constructs a new WorkListBuilder object.
   *
  ...
  public function render() {
    ...
    $build['summary']['#markup'] = $this->t('Total works: @total', ['@total' => $total]);
    return $build;
  }
  ...
  public function buildRow(EntityInterface $entity) {
    /* @var $entity \Drupal\md_worksheet\WorkInterface */
    $row['id'] = $entity->id();
